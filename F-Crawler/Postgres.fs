...
let pushdata(docs: Document array, connectionString:string) : uint64 =
    async {
        ...
        for doc in docs do
            ...
            writer.Write(doc.Emails, NpgsqlDbType.Array ||| NpgsqlDbType.Text)
            writer.Write(doc.CSSlinks, NpgsqlDbType.Array ||| NpgsqlDbType.Text)
            writer.Write(doc.JSlinks, NpgsqlDbType.Array ||| NpgsqlDbType.Text)
            ...
            writer.Write(doc.Metatags, NpgsqlDbType.Array ||| NpgsqlDbType.Text)
